...
import edu.cmu.ml.rtw.pra.util.Vector
...
class GraphChiPathFinder(
  ...
  override def findPaths(data: Dataset[NodePairInstance]) {
    ...
    // val edgesToExclude = relationMetadata.unallowedPairs.flatMap(i =>  List(((i._1, i._2), i._3), ((i._2, i._1), i._3))).toSeq

    pathTypeFactory = new BasicPathTypeFactory(graph) 
