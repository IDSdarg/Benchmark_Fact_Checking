...
if __name__ == '__main__':
 ...
 #            dest='level', help='Difficulty of level')
	...
	for i in range(10):
		print np.array(entities)[cut==values[i]].shape
	...
	output_filename = args.basedir + "splits/" +args.relation +  "/" + args.type + "_c" + str(args.consis) + "_h" + str(args.homo) + "_s" + str(args.size_scenario) + "_r" + str(args.pos_neg) + "_" + args.popular + "_" + args.cluster + "_scenario.tsv"
